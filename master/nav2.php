                  ...
                  <div class="col-lg-6">
                      <div class="call-area">
                          <span class="phone">
                              ...
                              <a href="tel:+447438517893">+44 7438 517893</a>
                          </span>
                          <span class="support">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav main-menu ml-auto mr-5">
                          ...
                          <li class="nav-item dropdown user-profile-dropdown">
                              ...
                              <div class="dropdown-menu position-absolute" aria-labelledby="servicesDropdown">
                                  <div class="___class_+?23___">
                                      <div class="dropdown-item">
                                          <a class="d-block" href="<?= $root ?>/services/nfp">Non Farm Payrolls (NFP)</a>
                                          <a class="d-block" href="<?= $root ?>/services/masternode">Masternode</a>
                                          <a class="d-block" href="<?= $root ?>/services/financial-services">Financial
                                              Services</a>
                                          <a class="d-block" href="<?= $root ?>/services/ipos">Initial Public
                                              Offerings
                                              (IPOs)</a>
                                          <a class="d-block" href="<?= $root ?>/services/comodity-trading">Comodity Trading</a>
                                          <a class="d-block" href="<?= $root ?>/services/pms">Portfolio Management Services</a>
                                          <a class="d-block" href="<?= $root ?>/services/structured-finance">Structured
                                              Finance</a>
                                          <a class="d-block" href="<?= $root ?>/services/consulting-services">Consulting
                                              Services</a>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <li><a href="#lan">Change language</a></li>
                      </ul>

                      <div class="header-action d-flex flex-wrap align-items-center">
                          <a href="<?= $root ?>/login" class="btn btn-default website-color  mr-1">Login</a>
                      </div>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-6">
                      ...
                      <h1 class="title py-3">Invest <span id="typewriter" style="color:#b58e43;"></span><br />With <?= $name ?></h1>
                      <p class="pb-4">
                          A Global Full Reserve Equity Investment Management Built On Decentralized Ledgers
                      </p>
                      <a href="register" class="btn btn-default website-color mt-1 mb-1">SIGN UP NOW</a>
                  </div>
                  <div class="col-lg-6 mt-3">
                      <!--<div class="coin_main"><img src="assetss/images/frontend/banner.png" alt="banner"></div>-->
                  </div>
              </div>
          </div>
      </div>
